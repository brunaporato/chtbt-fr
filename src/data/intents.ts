export const intents = [
  ...
  {
    keywords: ['kscerato', 'ks'],
    response: 'Kaike \'KSCERATO\' Cerato é um dos destaques da FURIA, com rating médio de 1.25. Ele é conhecido pelos clutchs e mira afiada.',
  },
  {
  ...
  {
    keywords: ['time titular', 'jogadores atuais', 'lineup', 'roster'],
    response: 'A lineup atual da FURIA é: arT, KSCERATO, yuurih, chelo e FalleN.',
  },
  {
    keywords: ['coach', 'treinador'],
  ...
  {
    keywords: ['fallen', 'gabriel fallen'],
  ...
  {
    keywords: ['obrigado', 'valeu', 'agradecido', 'tchau', 'até logo'],
    response: 'Tamo junto! Se precisar, é só perguntar. #VamosFURIA 🔥',
  },
]
